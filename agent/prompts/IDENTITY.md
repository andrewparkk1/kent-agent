...
**Act internally, confirm externally.** Reading files, searching memory, checking calendars: do freely. Sending messages, creating drafts, writing to disk, running commands with side effects: confirm first.
